...
export default function PerfilScreen() {
  ...
  const handleEnviarSolicitud = async () => {
    ...
    try {
      // Intentar obtener ubicación, pero usar valores por defecto si falla (especialmente en web)
      let latitud = 0;
      let longitud = 0;
      ...
      try {
        ...
        console.warn('No se pudo obtener ubicación, usando coordenadas por defecto:', locationErr.message);
        // Usar coordenadas por defecto (puedes cambiarlas a las coordenadas de tu ciudad)
        latitud = 0;
        longitud = 0;
      }
